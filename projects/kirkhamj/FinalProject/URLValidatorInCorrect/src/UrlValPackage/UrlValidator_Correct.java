 ...
 * <pre>
 *   Example of usage:
 *   Construct a UrlValidator_Correct  with valid schemes of "http", and "https".
 *
 *    String[] schemes = {"http","https"}.
 *    UrlValidator_Correct  UrlValidator_Correct  = new UrlValidator_Correct (schemes);
 *    if (UrlValidator_Correct .isValid("ftp://foo.bar.com/")) {
 ...
 *
 *    UrlValidator_Correct  UrlValidator_Correct  = new UrlValidator_Correct ();
 *    if (UrlValidator_Correct .isValid("ftp://foo.bar.com/")) {
 *       System.out.println("url is valid");
 *    } else {
 *       System.out.println("url is invalid");
 ...
 * @since Validator 1.4
 */
public class UrlValidator_Correct  implements Serializable {
     ...
     *  a {@link RegexValidator} instead ({@link #UrlValidator_Correct (RegexValidator, long)})
     */
     ...
     */
    private static final UrlValidator_Correct  DEFAULT_URL_VALIDATOR = new UrlValidator_Correct ();

    /**
     * Returns the singleton instance of this class with default schemes and options.
     * @return singleton instance with default schemes and options
     */
    public static UrlValidator_Correct  getInstance() {
        return DEFAULT_URL_VALIDATOR;
    }

    /**
     * Create a UrlValidator_Correct  with default properties.
     */
    public UrlValidator_Correct () {
        this(null);
    }
     ...
     */
    public UrlValidator_Correct (String[] schemes) {
        this(schemes, 0L);
    }

    /**
     * Initialize a UrlValidator_Correct  with the given validation options.
     * @param options The options should be set using the public constants declared in
     * this class.  To set multiple options you simply add them together.  For example,
     * ALLOW_2_SLASHES + NO_FRAGMENTS enables both of those options.
     */
    public UrlValidator_Correct (long options) {
     ...
     * ALLOW_2_SLASHES + NO_FRAGMENTS enables both of those options.
     */
    public UrlValidator_Correct (String[] schemes, long options) {
     ...
     */
    public UrlValidator_Correct (RegexValidator authorityValidator, long options) {
     ...
     * enables both of those options.
     */
    public UrlValidator_Correct (String[] schemes, RegexValidator authorityValidator, long options) {
