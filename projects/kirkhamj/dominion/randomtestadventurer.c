...
int randTestAdventurer(struct scen* scen, int v)
{
    ...
    //int otherPlayer = (genRandInt(1, scen->game->numPlayer) - 1);

    //setting to max_deck was dumb... of course 2 trearues will be there in crazy large decks! scen->game->deckCount[curPlayer] = (genRandInt(1, MAX_DECK, seed) - 1); //randomize player's deck
