...
int handleAdventurer(struct gameState *state, int currentPlayer, int nextPlayer); //line 1230
int handleSmithy(struct gameState *state, int currentPlayer, int handPos); //line 1258
